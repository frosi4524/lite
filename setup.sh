...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/frosi4524/ijin/main/liteip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/frosi4524/ijin/main/liteip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/frosi4524/ijin/main/liteip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/frosi4524/lite/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/frosi4524/lite/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/frosi4524/lite/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/frosi4524/lite/main/udp-custom/udp.sh && chmod +x udp.sh && ./udp.sh
clear
sleep 0.5
echo -e "\e[33m-----------------------------------\033[0m"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/frosi4524/ijin/main/liteip  )
