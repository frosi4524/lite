...
wget https://raw.githubusercontent.com/frosi4524/lite/main/slowdns/install-sldns && chmod +x install-sldns && ./install-sldns
sleep 1
echo "\e[1;32m Proses Download Script OpenVPN.. \e[0m"
wget https://raw.githubusercontent.com/frosi4524/lite/main/udp-custom/openvpn/openvpn.sh && chmod +x openvpn.sh && ./openvpn.sh
rm -rf /root/udp
mkdir -p /root/udp
# install udp-custom
echo ""
...
sleep 1
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://raw.githubusercontent.com/frosi4524/lite/main/udp-custom/udp-custom-linux-amd64" -O /root/udp/udp-custom && rm -rf /tmp/cookies.txt
...
sleep 1
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://raw.githubusercontent.com/frosi4524/lite/main/udp-custom/config.json" -O /root/udp/config.json && rm -rf /tmp/cookies.txt
